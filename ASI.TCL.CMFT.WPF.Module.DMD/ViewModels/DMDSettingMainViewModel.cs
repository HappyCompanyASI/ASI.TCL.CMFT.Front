...
{
    public class DMDSettingMainViewModel : BindableBase, IRegionMemberLifetime, INavigationAware
    {
        ...
        #region Constructors
        public DMDSettingMainViewModel()
        {
        }
        public DMDSettingMainViewModel(IRegionManager regionManager)
        {
        ...
        private void ExecuteNavigateCommand(string navigationPath)
        {
            ...
            _regionManager.RequestNavigate(RegionNames.DMDSettingsRegion, navigationPath);
        }
        #endregion
        ...
        {
            ExecuteNavigateCommand(NavigatePath.DMDPreRecordedMessageSettings);
        }
