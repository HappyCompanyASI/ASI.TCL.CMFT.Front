...
namespace ASI.TCL.CMFT.WPF.Assist
{
    public class MouseProperties
    {
        ...
        public static readonly DependencyProperty MouseUpCommandProperty =
            DependencyProperty.RegisterAttached("MouseUpCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseUpCommandChanged));
        ...
        public static readonly DependencyProperty MouseDownCommandProperty =
            DependencyProperty.RegisterAttached("MouseDownCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseDownCommandChanged));
        ...
        public static readonly DependencyProperty MouseLeaveCommandProperty =
            DependencyProperty.RegisterAttached("MouseLeaveCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseLeaveCommandChanged));
        ...
        public static readonly DependencyProperty MouseLeftButtonDownCommandProperty =
            DependencyProperty.RegisterAttached("MouseLeftButtonDownCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseLeftButtonDownCommandChanged));
        ...
        public static readonly DependencyProperty MouseLeftButtonUpCommandProperty =
            DependencyProperty.RegisterAttached("MouseLeftButtonUpCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseLeftButtonUpCommandChanged));
        ...
        public static readonly DependencyProperty MouseMoveCommandProperty =
            DependencyProperty.RegisterAttached("MouseMoveCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseMoveCommandChanged));
        ...
        public static readonly DependencyProperty MouseRightButtonDownCommandProperty =
            DependencyProperty.RegisterAttached("MouseRightButtonDownCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseRightButtonDownCommandChanged));
        ...
        public static readonly DependencyProperty MouseRightButtonUpCommandProperty =
            DependencyProperty.RegisterAttached("MouseRightButtonUpCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseRightButtonUpCommandChanged));
        ...
        public static readonly DependencyProperty MouseWheelCommandProperty =
            DependencyProperty.RegisterAttached("MouseWheelCommand", typeof(ICommand), typeof(MouseProperties), new FrameworkPropertyMetadata(MouseWheelCommandChanged));
