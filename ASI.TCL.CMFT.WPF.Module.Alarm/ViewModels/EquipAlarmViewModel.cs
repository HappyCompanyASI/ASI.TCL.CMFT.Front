...
{
    public class EquipAlarmViewModel : BindableBase, IRegionMemberLifetime
    {
        ...
        #region Constructors
        public EquipAlarmViewModel()
        {
        }
        public EquipAlarmViewModel( IDialogService dialogService, IEventAggregator eventAggregator)
        {
