...
namespace ASI.TCL.CMFT.WPF.Module.Alarm.ViewModels
{
    public class EventAlarmViewModel : BindableBase, IRegionMemberLifetime
    {
        ...
        #region Properties
        private ObservableCollection<EventAlarmDto> _eventAlarms = new();
        public ObservableCollection<EventAlarmDto> EventAlarms
        {
            get => _eventAlarms;
            set => SetProperty(ref _eventAlarms, value);
        }
