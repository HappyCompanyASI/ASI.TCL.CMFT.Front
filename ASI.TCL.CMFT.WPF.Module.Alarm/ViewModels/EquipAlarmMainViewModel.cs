...
{
    public class EquipAlarmMainViewModel : BindableBase, IRegionMemberLifetime
    {
        ...
        #region Constructors
        public EquipAlarmMainViewModel()
        {
        }
        public EquipAlarmMainViewModel( IDialogService dialogService, IEventAggregator eventAggregator)
        {
        ...
        #region Properties
        private ObservableCollection<EquipAlarmDto> _equipAlarms = new();
        public ObservableCollection<EquipAlarmDto> EquipAlarms
        {
            get => _equipAlarms;
            set => SetProperty(ref _equipAlarms, value);
        }
